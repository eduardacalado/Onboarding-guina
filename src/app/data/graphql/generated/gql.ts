...
type Documents = {
    ...
    "mutation UpdateCardOrder($data: [UpdateCardOrderInput!]!) {\n  updateCardOrder(data: $data)\n}": typeof types.UpdateCardOrderDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateCardOrder($data: [UpdateCardOrderInput!]!) {\n  updateCardOrder(data: $data)\n}"): (typeof documents)["mutation UpdateCardOrder($data: [UpdateCardOrderInput!]!) {\n  updateCardOrder(data: $data)\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateCard($data: UpdateCardInput!) {\n  updateCard(data: $data) {\n    id\n    name\n    column\n    createdAt\n    description\n    order\n    points\n  }\n}"): (typeof documents)["mutation UpdateCard($data: UpdateCardInput!) {\n  updateCard(data: $data) {\n    id\n    name\n    column\n    createdAt\n    description\n    order\n    points\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
